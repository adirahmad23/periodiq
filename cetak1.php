...
$user = $_SESSION['user'];
$brgs = $kon->kueri("SELECT * FROM tb_sebelum WHERE date BETWEEN '$startDate' AND '$endDate' AND user = '$user' ORDER BY id DESC");

$brgss = $kon->kueri("SELECT * FROM tb_sebelum WHERE user = '$user' ORDER BY id DESC");
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 30, 'LAPORAN DATA SEBELUM PENGECEKAN', 0, 1, 'C');
        // Garis pemisah
